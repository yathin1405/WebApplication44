...
namespace WebApplication44.Controllers
{
    public class AdminFlightsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,Airways,FROM,TO,SeatType,Departure_Date,DepartureTime,Flight_Duration,FDelay,Flight_Delay,Price")] AdminFlight adminFlight)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,Airways,FROM,TO,SeatType,Departure_Date,DepartureTime,Flight_Duration,FDelay,Flight_Delay,Price")] AdminFlight adminFlight)
        {
            if (ModelState.IsValid)
            {
